...
TEST_FILE_NAME = str(ROOT_DIR / "chatbot" / "evaluation" / "datasets" / "test.csv")
...
def run_evaluation():
    ...
    # --- 4. XUẤT BÁO CÁO ---
    output_file = ROOT_DIR / "chatbot" / "evaluation" / "results" / "baseline" / "baseline_evaluation_report.csv"
