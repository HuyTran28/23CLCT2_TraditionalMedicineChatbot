...
CHATBOT_DIR = EVALUATION_DIR.parent
...
CONFIG = {
    ...
    "test_file": str(EVALUATION_DIR / "datasets" / "test.csv")
}
CONFIG["persist_dir"] = str(CHATBOT_DIR / "vector_data")
...
def run_evaluation():
    ...
    output_file = EVALUATION_DIR / "results" / "proposed" / "evaluation_report_final.csv"
    df_res.to_csv(output_file, index=False, encoding="utf-8-sig")
    print(f"\nĐã lưu báo cáo vào: {output_file}")
