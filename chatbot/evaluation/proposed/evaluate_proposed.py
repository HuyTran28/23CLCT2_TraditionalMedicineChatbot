...
# Results file path
RESULTS_FILE = EVALUATION_DIR / "results" / "proposed" / "evaluation_proposed_final.csv"
...
VECTOR_DB_DIR = CHATBOT_DIR / "vector_data"
...
def main():
    ...
    test_csv = EVALUATION_DIR / "datasets" / "test.csv"
