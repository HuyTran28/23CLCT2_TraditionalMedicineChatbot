...
def _repo_root() -> Path:
    # main.py lives at: <repo>/code/chatbot/main.py
...
def build_arg_parser() -> argparse.ArgumentParser:
    # Robust default paths relative to the repository root.
    _root = _repo_root()
    ...
    _default_persist = _root / "code" / "chatbot" / "vector_data"
    ...
    ingest.add_argument("--persist-dir", default=str(_default_persist), help="Vector index directory (disk backend default)")
